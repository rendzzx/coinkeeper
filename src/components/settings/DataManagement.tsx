            ...
            <>
                ...
                >
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle
                                className={cn(!useEncryption && "line-through")}
                            >
                                {t("secureExport")}
                            </DialogTitle>
                            <DialogDescription>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    ...
                                    wallets, transactions, budgets, and
                                    settings. The application will be restored
