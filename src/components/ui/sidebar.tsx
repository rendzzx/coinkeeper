  ...
  (
    ...
    return (
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <div
          ref={ref}
          className="group/sidebar hidden sm:flex flex-col text-sidebar-foreground bg-sidebar border-r"
          data-state={state}
        ...
        >
          ...
          <div
            className={cn(
              "duration-200 fixed inset-y-0 z-20 flex h-full flex-col transition-[width] ease-linear",
              "w-[--sidebar-width]",
              "group-data-[collapsible=icon]/sidebar:w-[--sidebar-width-icon]",
