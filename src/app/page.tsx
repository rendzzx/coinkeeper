...
import { ArrowRight, BarChart, ShieldCheck, Smartphone, Globe, ChevronsUpDown, Check, CalendarClock, Landmark, PieChart } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background">
        ...
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
            <div className="flex flex-col sm:flex-row items-center gap-x-2 text-xs text-muted-foreground">
                ...
                <p>Made with ❤️ by <a href="https://rendzzx.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">rendzzx</a></p>
            </div>
                 ...
                 <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        ...
                        <DropdownMenuItem onSelect={() => setLanguage('id')}>
                            <Check className={cn("mr-2 h-4 w-4", lang === 'id' ? 'opacity-100' : 'opacity-0')} />
                            Bahasa Indonesia
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
